<?php 
$query = "SELECT * FROM `settings` WHERE `partner` = '$user_partner'";
...
while($row = mysqli_fetch_assoc($sql))
{
    ...
    $settings_collection = $row['collection'];
    $settings_database = $row['dbase'];
    $settings_id = $row['id'];
}
?>
        ...
        <div class="container-fluid">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                ...
                <input type="hidden" name="settingsid" value="<?php echo $settings_id ?>"
