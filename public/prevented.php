...
<head>
  ...
  <title><?php echo $eventName; ?> - Verhinderd</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Verhinderd</h1>
                    <p>Bent u verhinderd voor <?php echo $eventName; ?>?</p>
                    <p>Via onderstaand formulier geeft u aan verhinderd te zijn. U ontvangt dan geen e-mails meer over dit evenement.</p>
